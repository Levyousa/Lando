    ...
    <header>
        ...
        <div id="menu-mobile" class=".d-block d-sm-none">
            ...
            <div class="menu-close">
                <button id="close" class="btn btn-default"><i class="fas fa-times"></i></button>
            </div>
        </div>
        ...
        <div class="header-black">
            ...
            <div class="container">
                ...
                <button id="bars" type="button"> <i class="fas fa-bars"></i></button>
                <button id="search" type="button"> <i class="fas fa-search"></i></button>

                <ul class="float-end">
                    <!-- cabeçalho bandeira dos times e referencia com link-->
        ...
        <!-- Menu com as opções de compra, noticias e horários-->
        <div class="container">
