...
$app->get('/produtos', function () {
    ...
    foreach ($data as &$produto) {
        ...
        $produto['parcela'] = 10;
        $produto['parcelas'] = number_format($preco / $produto['parcela'], 2, ',', '.');
...
$app->get('/produtos-mais-buscados', function () {
    ...
    $data = $sql->select("SELECT tb_produtos.id_prod,
    ...
    tb_produtos.visivel, cast(avg(review) as dec(10,2)) as media, 
    count(id_prod) as reviews FROM hcode_shop.tb_produtos
